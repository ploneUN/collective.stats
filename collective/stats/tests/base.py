...
def setup_product():
    ...
    import collective.stats
    zcml.load_config('configure.zcml', collective.stats)
    ...
    ztc.installPackage('collective.stats')
...
setup_product()
ptc.setupPloneSite(products=['collective.stats'])
